...
.. image:: _static/GeneticAlgos.png
    :align: center
    :alt: Genetic Algos
...
`http://github.com/lkozelnicky/GeneticAlgos/ <http://github.com/lkozelnicky/GeneticAlgos/>`_

Usage
_____

``geneticalgos`` is available on `PYPI <https://pypi.org/project/GeneticAlgos/>`_.
...
with default values. However, you can change and tweak them easily - :doc:`Advanced usage <advanced>`.
